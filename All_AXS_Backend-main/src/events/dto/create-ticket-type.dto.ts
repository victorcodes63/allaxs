...
export class CreateTicketTypeDto {
  ...
  @ApiProperty({ description: 'Price in cents (non-negative integer)' })
  @Type(() => Number)
  @IsInt({ message: 'Price must be an integer (in cents)' })
  @Min(0, { message: 'Price must be non-negative' })
  priceCents!: number;

  @ApiProperty({ description: 'Total quantity available', minimum: 0 })
  ...
  @IsOptional()
  @ValidateIf((o: CreateTicketTypeDto) => o.allowInstallments === true)
  @ValidateNested()
  @Type(() => InstallmentConfigDto)
